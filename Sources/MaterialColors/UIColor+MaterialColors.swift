...
extension UIColor {
    ...
    /// - Returns: The `UIColor`
    public static func material(_ color: MaterialColor, alpha: CGFloat = 1.0) -> UIColor {
    ...
    /// - Returns: The `UIColor`
    @available(iOS 13.0, *)
    public static func material(light: MaterialColor, dark: MaterialColor, lightAlpha: CGFloat = 1.0, darkAlpha: CGFloat = 1.0) -> UIColor {
    ...
    private convenience init(hex6: UInt32, alpha: CGFloat) {
